// ============================================
// MOBILE UTILITIES FOR CODEVANCE LAB
// ============================================

const CodevanceMobileUtils = {
    isMobile() {
    ...
    enhanceTouchFeedback() {
        const interactiveElements = document.querySelectorAll('.difficulty-btn, .challenge-btn, .option-btn, button, .btn, .code-option');
